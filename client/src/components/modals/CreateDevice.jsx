...
import {createDevice, fetchBrands, fetchDevices, fetchTypes} from "../../app/api/deviceAPI";
...
const CreateDevice = observer(({show, onHide}) => {
	...
	const addDevice = () => {
		...
		const checkedName = checkName(name, device.devices.rows)
		if (checkedName[0] === 'Error') {
			setName(checkedName[1])
		} else {
